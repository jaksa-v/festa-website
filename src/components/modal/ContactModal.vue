...
<template>
  ...
  >
    <div class="flex flex-col gap-y-2">
      <p class="text-xl font-light">Contact Us:</p>
      <div>
      ...
      <form class="flex flex-col gap-y-1">
        ...
        ></textarea>
        <button class="bg-festa-500 ms-auto mt-2 px-4 py-1.5" type="submit">
          <span class="text-xs font-light text-white">SEND MESSAGE</span>
        </button>
      </form>
    </div>
  </Modal>
